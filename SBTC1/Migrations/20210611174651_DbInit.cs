        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainTime = table.Column<string>(nullable: true),
                    Ratings = table.Column<string>(nullable: true),
                    TotalSeat = table.Column<int>(nullable: false),
                    TrainVehicleNumber = table.Column<string>(nullable: false),
                    RouteSequence = table.Column<string>(nullable: false),
                    TrainOperatorId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Train", x => x.TrainId);
                    table.ForeignKey(
                        name: "FK_Train_AspNetUsers_TrainOperatorId",
                        column: x => x.TrainOperatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrainRouteId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seat_TrainRoute_TrainRouteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Train_TrainOperatorId",
                table: "Train",
                column: "TrainOperatorId",
                unique: true,
                filter: "[TrainOperatorId] IS NOT NULL");
